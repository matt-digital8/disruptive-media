...
<head>
  ...
  ================================================== -->
    ...
    var MTUserId='10989c93-3692-4899-af98-b06501108ad0';
    var MTFontIds = new Array();

    MTFontIds.push("1475948"); // Univers® W04 45 Light 
    MTFontIds.push("1475960"); // Univers® W04 55 Roman 
    MTFontIds.push("1475972"); // Univers® W04 65 Bold 
    (function() {
        var mtTracking = document.createElement('script');
        mtTracking.type='text/javascript';
        mtTracking.async='true';
        mtTracking.src='http://dm.nealweb.design/wp-content/themes/fortuna-child/fonts/mtiFontTrackingCode.js';
...
<style type="text/css">
	...
	<?php wp_head(); ?>	
	<link rel='stylesheet' id='boc-main-styles-css'  href='http://dm.nealweb.design/wp-content/themes/fortuna-child/responsive.css' type='text/css' media='all' />
</head>
			...
			<div class="container">
				...
				<?php	} ?>
					...
					<div id="mobile_menu_toggler">
					  <div id="m_nav_menu" class="m_nav hoverli">
<!-- 						<div class="m_nav_ham button_closed" id="m_ham_1"></div>
						<div class="m_nav_ham button_closed" id="m_ham_2"></div>
						<div class="m_nav_ham button_closed" id="m_ham_3"></div> -->
						<div style="display: flex; height: 100%; flex-direction: column; justify-content: space-around; align-items: center;"><img class="img-responsive" width="35px" height="auto" src="/wp-content/uploads/2017/08/menu-icon.png"><img class="img-responsive-white" width="35px" height="auto" src="/wp-content/uploads/2017/09/white-menu.png"><span style="color: black; font-size: 8pt; font-weight: bold; line-height: initial;?">MENU</span></div>
					  </div>
					</div>
